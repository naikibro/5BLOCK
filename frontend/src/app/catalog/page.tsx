    ...
    <div className="container mx-auto py-8 px-4">
      ...
      <div className="flex flex-col sm:flex-row gap-4 mb-6">
        ...
        <div className="relative">
          <select
            ...
            className="w-full appearance-none px-4 py-2 pr-10 border border-border rounded-md bg-card text-card-foreground focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-colors cursor-pointer shadow-sm"
      ...
      {error && (
        <div className="text-center py-12" role="alert">
          <p className="text-red-500 dark:text-red-400 font-medium">Error loading Pokémon. Please try again.</p>
